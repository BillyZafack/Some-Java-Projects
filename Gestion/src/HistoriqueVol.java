 ...
 * @author Zafack Billy
 */
public class HistoriqueVol extends javax.swing.JDialog {

	class Actionhvl implements ActionListener {
	...
	/**
	 * Creates new form HistoriqueVol
	 */
	public HistoriqueVol(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				".\\images\\fenetre.png"));
		reinittab();
		initComponents();
		ok.addActionListener(new Actionhvl());
	}
	...
	public String[][] element() {
		...
		try {
			...
			ResultSet res = stmt.executeQuery("SELECT * FROM Vol");
			while (res.next()) {
				k++;
			}
			data = new String[k][5];
