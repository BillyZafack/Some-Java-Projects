 ...
 * @author Zafack Billy
 */
public class HistoriqueAchat extends javax.swing.JDialog {

	class Actionha implements ActionListener {
	...
	/**
	 * Creates new form HistoriqueAchat
	 */
	public HistoriqueAchat(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				".\\images\\fenetre.png"));
		initComponents();
		ok.addActionListener(new Actionha());
		reinittab();
	}
	...
	public String[][] element() {
		...
		try {
			...
			for (int i = 0; i < k; i++) {
				...
				data[i][1] = getFNom(res.getString("FournisseurID"));
				data[i][2] = res.getString("NbUnite");
				data[i][3] = res.getString("PrixAchat");
				data[i][4] = res.getString("DateAchat");
				res.next();
			}
	...
	public String getFNom(String n) {
		String d = null;
		try {
			Statement stmt = Fenetre.getConnection().createStatement();
			ResultSet r = stmt
					.executeQuery("SELECT Nom,Prenom FROM Fournisseur WHERE FournisseurID="
							+ n);
			r.next();
	...
	private void initComponents() {
		...
		recherche1.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
				"Nom du Produit", "Nom du Fournisseur", "No D'Unités Achetes",
				"Prix D'Achat", "Date D'Achat" }));

		table.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

		}, new String[] { "Nom Du Produit", "Nom Du Fournisseur",
				"No D'Unites Achetés", "Prix D'Achat", "Date D'Achat" }) {
	...
	public void reinittab() {
		String[][] f = element();
		String[] s = { "Nom Du Produit", "Nom Du Fournisseur",
				"No D'Unites Achetés", "Prix D'Achat", "Date D'Achat" };
